 ...
 * @author alice
 */
public class FormRecDetalhada extends javax.swing.JFrame {

    /**
     * Creates new form FormRecDetalhada
     */
    public FormRecDetalhada() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRecDetalhada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormRecDetalhada().setVisible(true);
            }
        });
    }
